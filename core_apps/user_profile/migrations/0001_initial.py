        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.UUIDField(
                        default=uuid.UUID("6d2c54d5-df75-4310-beaa-71db1cfb132c"),
                        editable=False,
                        primary_key=True,
                        serialize=False,
                    ),
                ...
                (
                    ...
                    django_countries.fields.CountryField(
                        default="MX", max_length=2, verbose_name="Country of Birth"
                    ),
                ),
                (
                    "place_of_birth",
                    models.CharField(
                        default="Unkwown", max_length=50, verbose_name="Place of Birth"
                    ),
                ),
                (
                    "marital_status",
                ...
                (
                    "nationality",
                    models.CharField(
                        default="Unkwown", max_length=30, verbose_name="Nationality"
                    ),
                ),
                (
                    "phone_number",
                    phonenumber_field.modelfields.PhoneNumberField(
                        default="+525555555555",
                        max_length=30,
                        region=None,
                ...
                (
                    "address",
                    models.CharField(
                        default="Unkwown", max_length=100, verbose_name="Address"
                    ),
                ),
                (
                    "country",
                    models.CharField(
                        default="Unkwown", max_length=50, verbose_name="Country"
                    ),
                ),
                (
                    "city",
                    django_countries.fields.CountryField(
                        default="MX", max_length=2, verbose_name="City"
                    ),
                ),
                (
                    "employment_status",
