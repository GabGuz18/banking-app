...
class Profile(TimeStampedModel):
    ...
    place_of_birth = models.CharField(
        _("Place of Birth"), max_length=50, default="Unkwown"
    )
    ...
    id_issue_date = models.DateField(_("ID Issue Date"), default=settings.DEFAULT_DATE)
    id_expiry_date = models.DateField(
        _("ID Expiry Date"), default=settings.DEFAULT_EXPIRY_DATE
    )
    passport_number = models.CharField(
        _("Passport Number"), max_length=20, blank=True, null=True
    )
    nationality = models.CharField(_("Nationality"), max_length=30, default="Unkwown")
    phone_number = PhoneNumberField(
        _("Phone Number"), max_length=30, default=settings.DEFAULT_PHONE_NUMBER
    )
    address = models.CharField(_("Address"), max_length=100, default="Unkwown")
